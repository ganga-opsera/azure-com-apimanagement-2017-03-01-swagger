...
func Policy_listbyserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/policies%s", cfg.BaseURL, resourceGroupName, serviceName, subscriptionId, queryString)
		...
		var result models.PolicyCollection
...
func CreatePolicy_listbyserviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_policies",
		mcp.WithDescription("Lists all the Global Policy definitions of the Api Management service."),
		...
		mcp.WithString("scope", mcp.Description("Policy scope.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Policy_listbyserviceHandler(cfg),
	}
}
