...
func Policy_createorupdateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.PolicyContract
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/policies/%s%s", cfg.BaseURL, resourceGroupName, serviceName, policyId, subscriptionId, queryString)
		...
		var result models.PolicyContract
...
func CreatePolicy_createorupdateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_policies_policyId",
		mcp.WithDescription("Creates or updates the global policy configuration of the Api Management service."),
		...
		mcp.WithString("policyId", mcp.Required(), mcp.Description("The identifier of the Policy.")),
		...
		mcp.WithObject("properties", mcp.Description("Input parameter: Policy contract Properties.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    Policy_createorupdateHandler(cfg),
	}
}
