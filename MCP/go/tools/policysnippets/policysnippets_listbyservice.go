...
func Policysnippets_listbyserviceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/subscriptions/%s/resourceGroups/%s/providers/Microsoft.ApiManagement/service/%s/policySnippets%s", cfg.BaseURL, resourceGroupName, serviceName, subscriptionId, queryString)
		...
		var result models.PolicySnippetsCollection
...
func CreatePolicysnippets_listbyserviceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_subscriptions_subscriptionId_resourceGroups_resourceGroupName_providers_Microsoft_ApiManagement_service_serviceName_policySnippets",
		mcp.WithDescription("Lists all policy snippets."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Policysnippets_listbyserviceHandler(cfg),
	}
}
